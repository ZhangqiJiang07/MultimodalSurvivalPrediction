...
class AtteNet(nn.Module):
    ...
    def __init__(self, mirna_lenth, cnv_lenth, embedding_sizes, n_cont, n_model, m_lenth):
    ...
    def forward(self, mirna, cnv, clin_cat, clin_cont):
