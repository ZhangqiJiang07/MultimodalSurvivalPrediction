...
class AtteNet(nn.Module):
    ...
    def __init__(self, mrna_lenth, mirna_lenth, embedding_sizes, n_cont, n_model, m_lenth):
    ...
    def forward(self, mrna, mirna, clin_cat, clin_cont):
        ...
        v = atten_fusion3(mrna, mirna, clin)
