...
var_arr = np.array(data_mirna.var())
var_list_idx = np.argsort(-var_arr)
top100idx = var_list_idx[:100]
data_mirna_100 = data_mirna.loc[:, top100idx]


# min-max normalization
scaler = MinMaxScaler()
mirna_0_1 = scaler.fit_transform(data_mirna_100)
...
mirna.to_csv(f'/preprocessed_data/PC_miRNA_100.csv', header=False, index=False)
